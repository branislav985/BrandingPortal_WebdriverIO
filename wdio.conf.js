...
process.env.user_temp= process.env.USERNAME_TEMP;
process.env.pass_temp= process.env.PASSWORD_TEMP;
...
export const config = {
    ...
    baseUrl: 'https://qateam:Noowb1xFP@staging-branding.counterpath.com/',
    //
